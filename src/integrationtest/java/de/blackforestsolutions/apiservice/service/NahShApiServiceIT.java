...
class NahShApiServiceIT {
    ...
    void test_getStationId() {
        ApiTokenAndUrlInformation testData = getNahShTokenAndUrl("Eiderstraße 87", null);
    ...
    void test_getJourney() {
        ApiTokenAndUrlInformation testData = getNahShTokenAndUrl("981068999", "4397734");
