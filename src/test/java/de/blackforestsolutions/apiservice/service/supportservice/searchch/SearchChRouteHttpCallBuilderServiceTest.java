...
class SearchChRouteHttpCallBuilderServiceTest {
    ...
    void test_buildPathWith_pathVariable_searchChRoutePathVariable_departure_startLocation_arrival_destinationLocation_datePathVariable_departureDate_timePathVariable_delayParameter_results_returns_valid_string() {
        ApiTokenAndUrlInformation testData = ApiTokenAndUrlInformationObjectMother.getSearchChRouteTokenAndUrl();
    ...
    void test_buildPathWith_pathVariable_searchChRoutePathVariable_as_null_departure_startLocation_arrival_destinationLocation_datePathVariable_departureDate_timePathVariable_delayParameter_results_throws_NullpointerException() {
        ...
        ApiTokenAndUrlInformation.ApiTokenAndUrlInformationBuilder builder = new ApiTokenAndUrlInformation.ApiTokenAndUrlInformationBuilder();
        builder = builder.buildFrom(testData);
        builder.setSearchChRoutePathVariable(null);
        testData = builder.build();
    ...
    @Test
    void test_buildPathWith_pathVariable_searchChRoutePathVariable_departure_startLocation_as_null_arrival_destinationLocation_datePathVariable_departureDate_timePathVariable_delayParameter_results_throws_NullpointerException() {
        ApiTokenAndUrlInformation testData = ApiTokenAndUrlInformationObjectMother.getSearchChRouteTokenAndUrl();
        ApiTokenAndUrlInformation.ApiTokenAndUrlInformationBuilder builder = new ApiTokenAndUrlInformation.ApiTokenAndUrlInformationBuilder();
        builder = builder.buildFrom(testData);
        builder.setStartLocation(null);
        testData = builder.build();
    ...
    @Test
    void test_buildPathWith_pathVariable_searchChRoutePathVariable_departure_startLocation_arrival_destinationLocation_as_null_datePathVariable_departureDate_timePathVariable_delayParameter_results_throws_NullpointerException() {
        ApiTokenAndUrlInformation testData = ApiTokenAndUrlInformationObjectMother.getSearchChRouteTokenAndUrl();
        ApiTokenAndUrlInformation.ApiTokenAndUrlInformationBuilder builder = new ApiTokenAndUrlInformation.ApiTokenAndUrlInformationBuilder();
        builder = builder.buildFrom(testData);
        builder.setDestinationLocation(null);
        testData = builder.build();
